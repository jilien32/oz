...
class Blog(TimestampModel):
    ...
    # ImageField, FileField와 같지만 이미지만 업로드하게 되어있다.
    # varchar => 이미지 경로만 저장
    ...
    def save(self, *args, **kwargs):
        ...
        thumbnail_name = image_path.stem # /blog/2024/4/23/database.png => database 이미지명 추출
        thumbnail_extension = image_path.suffix.lower() # /blog/2024/4/23/database.png => .png 파일명 추출
